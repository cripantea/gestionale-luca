...
const form = useForm({
    ...
    // Economico
    accordo_economico_mensile: null,
    dettagli_accordo: '',
    potenziale_upsell: null,
    note_upsell: '',
    
    // Tracking
    data_acquisizione: new Date().toISOString().split('T')[0],
    livello_soddisfazione: null,
    nps_score: null,
});
                    ...
                    <div class="p-6">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                                <Link :href="route('clients.index')" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300">
                                    Annulla
                                </Link>
