...
<template>
    <div>
        <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
                        ...
                        <div class="flex">
                            ...
                            >
                                ...
                                <Dropdown align="left" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('project-types.index')">
                                            Tipi Progetto
                                        </DropdownLink>
                                        <DropdownLink :href="route('task-templates.index')">
                                            Template Task
                                        </DropdownLink>
                                    </template>
                                </Dropdown>
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink
                            ...
                            :active="route().current('project-types.*')"
                        >
                            Tipi Progetto
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            :href="route('task-templates.index')"
                            :active="route().current('task-templates.*')"
                        >
                            Template Task
                        </ResponsiveNavLink>
                    </div>
            ...
            <!-- Page Heading -->
            <header
                class="bg-white/80 backdrop-blur-sm shadow-sm dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-700"
                v-if="$slots.header"
            >
